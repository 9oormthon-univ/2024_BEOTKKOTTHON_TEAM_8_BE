...
//    public BaseResponse<PostJoinRes> timeSetting(@PathVariable Long userId, @RequestBody PostTimeReq postTimeReq) {
//        try {
//            String startTime = postTimeReq.getStartTime();
//            String endTime = postTimeReq.getEndTime();
//
//            // 이름, 비밀번호 제대로 들어왔는지 검사
////            BaseResponseStatus status = isJoinValid(name, password);
//            if(status != BaseResponseStatus.SUCCESS) {
...
//    public BaseResponseStatus isTimeValid(String startTime, String endTime) {
